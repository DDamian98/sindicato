                ...
                >
                    ...
                    <div className="grid">
                        ...
                        <div className="flex flex-wrap items-center text-center justify-center gap-8 mt-4">
                            <div className="bg-white rounded-lg overflow-hidden  shadow-lg border-gray-200 border-2  w-48 h-48">
                            ...
                            <div className="bg-white rounded-lg overflow-hidden  shadow-lg border-gray-200 border-2  w-48 h-48">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="text-primary w-28 h-28 mx-auto pt-6" aria-hidden="true" fill="currentColor">
                    ...
                    <div className="grid mt-4">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-8 text-center mt-4">
                            ...
                            <div className="bg-white rounded-lg overflow-hidden  shadow-lg border-gray-200 border-2  w-48 h-48">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384  512" className="text-primary w-28 h-28 mx-auto pt-6" aria-hidden="true" fill="currentColor">
