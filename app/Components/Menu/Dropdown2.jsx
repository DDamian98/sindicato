  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex justify-start  w-full  border-gray-300 bg-white sm:pr-4 sm:py-2 sm:text-[16px]  md:pr-4 md:py-0  pl-3  text-sm font-medium text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:text-gray-300 "
      >
        <span className='hover:text-primary'>Difusión</span>
