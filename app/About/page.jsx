      ...
      <div className={`${styles.bg} py-4`}>
        ...
        <div className=" max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6   mb-20 text-secundary text-center">
          <div className="bg-white rounded-lg overflow-hidden  shadow-lg border-gray-200 border-2">
            <Image src="images/Valor1.png" width={112} height={112} alt="Valor" className="mx-auto pt-6">
            </Image>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md border-gray-200 border-2 ">
            <Image src="images/Valor2.png" width={112} height={112} alt="Valor" className="mx-auto pt-6">
            </Image>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md border-gray-200 border-2">
            <Image src="images/Valor3.png" width={112} height={112} alt="Valor" className="mx-auto pt-6">
            </Image>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md border-gray-200 border-2">
            <Image src="images/Valor4.png" width={112} height={112} alt="Valor" className="mx-auto pt-6">
            </Image>
            <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1">
          ...
          <div className="flex flex-wrap  justify-center items-center text-center gap-8 mt-4 ">
            <div className="flex flex-col flex-grow   p-2 w-[200px] h-[200px] transition duration-300 ease-in-out  hover:shadow-xl ">
              <span className="text-secundary font-bold">Sección Mann+Hummel</span>
